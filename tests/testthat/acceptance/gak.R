...
test_that("Symmetric univariate GAK distance gives expected results.", {
    ...
    D3 <- proxy::dist(data_subset, data_subset, method = "gak", window.size = 18L, sigma = sigma)
...
test_that("Symmetric multivariate GAK distance gives expected results.", {
    ...
    D3 <- proxy::dist(data_multivariate, data_multivariate, method = "gak", window.size = 18L, sigma = sigma)
