...
rep_pampre <- dtwclust(data_matrix, type = "partitional", k = 20,
...
test_that("Repetitions with pam.precompute give appropriate length",
          expect_identical(length(rep_pampre), ctrl@nrep))
...
rep_median <- dtwclust(data_matrix, type = "partitional", k = 20,
...
test_that("Repetitions without pam.precompute give appropriate length",
          expect_identical(length(rep_median), ctrl@nrep))
