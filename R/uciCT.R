...
#'
#' The subset included here (\code{CharTraj}) has only 5 examples of the X velocity for each
#' character. A vector with labels is also loaded in \code{CharTrajLabels}.
#'
