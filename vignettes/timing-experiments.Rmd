...
ggdf <- reshape2::melt(clus_dtwb_dtwlb_pam_results, id.vars=c("num_series", "k", "window_size"))
ggplot(ggdf,
       aes(x = num_series,
           y = value,
           colour = factor(window_size))) +
...
ggdf <- reshape2::melt(clus_dtwb_dtwlb_dba_results, id.vars=c("num_series", "k", "window_size"))
ggplot(ggdf,
       aes(x = num_series,
           y = value,
           colour = factor(window_size))) +
...
## PAM centroids with sparse matrices
