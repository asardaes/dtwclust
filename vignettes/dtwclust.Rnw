...
This example performs autocorrelation-based fuzzy clustering as investigated by \citet{durso2009}. Using the autocorrelation function overcomes the problem of time-series with different length.
