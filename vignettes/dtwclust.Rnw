...
Most of the improvements are either related to the distance measure used to assess dissimilarity,
or the function used to calculate prototypes or centroids.
...
In this manuscript, a general overview of time-series clustering is given,
