...
\blankfootnote{This manuscript was last updated in version 4.1.0 of \dtwclust{}.}
...
Naturally, fuzzy partitions usually have no ground truth associated with them.
...
Several of the best-performing CVIs according to \citet{arbelaitz2013} and \citet{wang2007} are implemented in \dtwclust{} in the \code{cvi} function,
